...
| Cosmic Gradient Hue | `linear-gradient(to right, rgb(147, 112, 233), rgb(254, 147, 125), rgb(243, 188, 185), rgb(232, 229, 246))` | `--color-cosmic-gradient-hue` | Background for hero sections, prominent visual elements. This is a complex gradient, suggesting advanced technology and a modern aesthetic |
| Plasma Gradient Hue | `linear-gradient(125deg, rgb(65, 103, 233) 8.27%, rgb(125, 104, 255) 32.42%, rgb(255, 147, 124) 64.48%, rgb(255, 188, 68) 96.1%)` | `--color-plasma-gradient-hue` | Decorative background gradient used for dynamic or highlighted elements, conveying energy |
...
:root {
  ...
  --gradient-cosmic-gradient-hue: linear-gradient(to right, rgb(147, 112, 233), rgb(254, 147, 125), rgb(243, 188, 185), rgb(232, 229, 246));
  --color-plasma-gradient-hue: #4167e9;
  --gradient-plasma-gradient-hue: linear-gradient(125deg, rgb(65, 103, 233) 8.27%, rgb(125, 104, 255) 32.42%, rgb(255, 147, 124) 64.48%, rgb(255, 188, 68) 96.1%);
