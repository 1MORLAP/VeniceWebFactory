...
### meno-display-condensed — Headline display text. The ultra-light weight combined with its elaborate, high-contrast display serif forms a dramatic visual identity, giving an artistic, editorial feel. Weight 300 makes it whisper instead of shout – authority through restraint, not volume. · `--font-meno-display-condensed`
- **Weights:** 300
- **Sizes:** 28px
- **Line height:** 1.50
- **Letter spacing:** normal
...
:root {
  ...
  --font-meno-display-condensed: 'meno-display-condensed', ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;
